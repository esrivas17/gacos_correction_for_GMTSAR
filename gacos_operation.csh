#!/bin/csh -f
 ...
 #   echo "  Performs gacos correction for Sentinel 1"
 #   echo ""
 #   echo "It works in each directory where the unwrap phases are located "
 #   echo ""
...
#######FIRST ZTD to grid#########
set x_first_d1 = `cat $1.rsc|grep X_FIRST|awk '{print $2}'`
set y_first_d1 = `cat $1.rsc|grep Y_FIRST|awk '{print $2}'`
set width_d1   = `cat $1.rsc|grep WIDTH|awk '{print $2}'`
set length_d1  = `cat $1.rsc|grep FILE_LENGTH|awk '{print $2}'`
set x_step_d1  = `cat $1.rsc|grep X_STEP|awk '{print $2}'`
set y_step_d1  = `cat $1.rsc|grep X_STEP|awk '{print $2}'`
...
#######SECOND ZTD to grid#########
set x_first_d2 = `cat $3.rsc|grep X_FIRST|awk '{print $2}'`
set y_first_d2 = `cat $3.rsc|grep Y_FIRST|awk '{print $2}'`
set width_d2   = `cat $3.rsc|grep WIDTH|awk '{print $2}'`
set length_d2  = `cat $3.rsc|grep FILE_LENGTH|awk '{print $2}'`
set x_step_d2  = `cat $3.rsc|grep X_STEP|awk '{print $2}'`
set y_step_d2  = `cat $3.rsc|grep X_STEP|awk '{print $2}'`
...
gmt grdmath unwrap.grd szpddm_phase_LOS.grd SUB = unwrap_GACOS_corrected.grd

#DETRENDING
gmt grdtrend unwrap_GACOS_corrected.grd -N3r -Dunwrap_GACOS_corrected_detrended.grd
...
echo "GACOS correction done with $date_ztd_d1 and $2 "
